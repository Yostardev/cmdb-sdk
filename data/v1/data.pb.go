...
var file_data_v1_data_proto_goTypes = []interface{}{
	...
	(*general.PaginateInfo)(nil),       // 36: general.PaginateInfo
...
var file_data_v1_data_proto_depIdxs = []int32{
	...
	34, // 18: data.GetDocumentRequest.RequestID:type_name -> general.RequestID
	20, // 19: data.GetDocumentRequest.Option:type_name -> data.GetDocumentOption
	34, // 20: data.InsertDocumentRequest.RequestID:type_name -> general.RequestID
	22, // 21: data.InsertDocumentRequest.Option:type_name -> data.InsertDocumentOption
	34, // 22: data.UpdateDocumentRequest.RequestID:type_name -> general.RequestID
	24, // 23: data.UpdateDocumentRequest.Option:type_name -> data.UpdateDocumentOption
	34, // 24: data.DeleteDocumentRequest.RequestID:type_name -> general.RequestID
	26, // 25: data.DeleteDocumentRequest.Option:type_name -> data.DeleteDocumentOption
	34, // 26: data.BatchDeleteDocumentRequest.RequestID:type_name -> general.RequestID
	28, // 27: data.BatchDeleteDocumentRequest.Option:type_name -> data.BatchDeleteDocumentOption
	36, // 28: data.ListDocumentResponse.Paginate:type_name -> general.PaginateInfo
	15, // 29: data.DataService.CreateCollection:input_type -> data.CollectionRequest
	15, // 30: data.DataService.DeleteCollection:input_type -> data.CollectionRequest
	17, // 31: data.DataService.CreateUniqueIndex:input_type -> data.UniqueIndexRequest
	17, // 32: data.DataService.DeleteUniqueIndex:input_type -> data.UniqueIndexRequest
	19, // 33: data.DataService.ListDocument:input_type -> data.ListDocumentRequest
	1,  // 34: data.DataService.AllDocument:input_type -> data.AllDocumentRequest
	21, // 35: data.DataService.GetDocument:input_type -> data.GetDocumentRequest
	23, // 36: data.DataService.InsertDocument:input_type -> data.InsertDocumentRequest
	25, // 37: data.DataService.UpdateDocument:input_type -> data.UpdateDocumentRequest
	27, // 38: data.DataService.DeleteDocument:input_type -> data.DeleteDocumentRequest
	29, // 39: data.DataService.BatchDeleteDocument:input_type -> data.BatchDeleteDocumentRequest
	12, // 40: data.DataService.GetTreeNodes:input_type -> data.GetTreeNodesRequest
	8,  // 41: data.DataService.GetResourceCount:input_type -> data.GetResourceCountRequest
	5,  // 42: data.DataService.Distinct:input_type -> data.DistinctRequest
	3,  // 43: data.DataService.Relation:input_type -> data.RelationRequest
	37, // 44: data.DataService.CreateCollection:output_type -> google.protobuf.Empty
	37, // 45: data.DataService.DeleteCollection:output_type -> google.protobuf.Empty
	37, // 46: data.DataService.CreateUniqueIndex:output_type -> google.protobuf.Empty
	37, // 47: data.DataService.DeleteUniqueIndex:output_type -> google.protobuf.Empty
	33, // 48: data.DataService.ListDocument:output_type -> data.ListDocumentResponse
	32, // 49: data.DataService.AllDocument:output_type -> data.DocumentsResponse
	30, // 50: data.DataService.GetDocument:output_type -> data.GetDocumentResponse
	31, // 51: data.DataService.InsertDocument:output_type -> data.DocumentResponse
	31, // 52: data.DataService.UpdateDocument:output_type -> data.DocumentResponse
	37, // 53: data.DataService.DeleteDocument:output_type -> google.protobuf.Empty
	37, // 54: data.DataService.BatchDeleteDocument:output_type -> google.protobuf.Empty
	13, // 55: data.DataService.GetTreeNodes:output_type -> data.GetTreeNodesResponse
	10, // 56: data.DataService.GetResourceCount:output_type -> data.ResourceCountResponse
	6,  // 57: data.DataService.Distinct:output_type -> data.DistinctResponse
	37, // 58: data.DataService.Relation:output_type -> google.protobuf.Empty
